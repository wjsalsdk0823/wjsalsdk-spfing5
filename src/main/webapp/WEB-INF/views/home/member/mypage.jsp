		...
		<fieldset>
			...
			<ul class="app_list">
				...
				<li class="clear">
					...
					<div class="app_content"><input value="${memberVO.user_name}" type="digits" name="user_name" class="w100p" id="user_name_lbl" placeholder="사용자이름을 입력해주세요" required/></div>
				</li>
				<li class="clear">
...
$(document).ready(function(){
	$("#btn_leave").click(function(){
		if(confirm('탈퇴하시겠습니까?')) {
			...
			form_leave.attr("action","/member/mypage_leave");//크롬 오동작으로 추가
			form_leave.submit();
