    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <form name="form_view" method="post" accept="/admim/board/board_update_form"  enctype="multipart/form-data">
            <div class="card-body">
               ...
               <c:forEach begin="0" end="1" var="idx">
	                ...
	                <div class="input-group">
	                  ...
	                  <!-- 첨부파일을 URL로 직접 접근하지 못하기 때문에 다운로드 전용 매서드 생성 -->
	                    ...
	                    <!-- jstl에서 변수사용하기 fn.split('데이터','분할기준값')목적:확장자를 이용해서 이미지 미리보기를 결정
	                    ...
	                    <!-- 위 extName = fineNameArray[2] = jpg -->
	                    <!-- 자바언어로switch~ case문~default -->
	                    <!-- containsIgnoreCase('찾을 값의문장','비교기준값' -->
	                    <c:choose>
 		...
 		<div class="col-md-12">
		  ...
		  <div class="timeline">
			...
			<div class="time-label">
			  <span class="bg-red" data-toggle="collapse" href="#collapseReply" 
			  role="button" id="btn_reply_list">
				  댓글리스트
				  [<span>1</span>]
				</span>
			</div>
			...
			<!--time-label 이후 after요소로 템플릿 결과가 여기에 출력-->
			<!-- /.timeline-label -->
			<!-- timeline item -->
