  ...
  <div class="card card-primary">
    ...
    <form name="form_write" method="post" action="/admin/board/board_update" enctype="multipart/form-data">
      <div class="card-body">
        <div class="form-group">
          ...
          <c:forEach var="boardTypeVO" items="${listBoardTypeVO}">
            <option ${boardVO.board_type==boardTypeVO.board_type?'selected':''} value="${boardTypeVO.board_type}">${boardTypeVO.board_name}선택</option>          
          </c:forEach>
      ...
      <div class="card-footer text-right">
        ...
        <a href="/admin/board/board_view?bno=${boardVO.bno}&bno=${pageVO.page}&search_type=${pageVO.search_type}" class="btn btn-warning">뷰화면</a>
      </div>
