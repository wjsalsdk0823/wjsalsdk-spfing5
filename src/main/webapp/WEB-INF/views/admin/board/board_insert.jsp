    ...
    <form name="form_write" method="post" action="/admin/board/board_insert" enctype="multipart/form-data">
      <div class="card-body">
        <div class="form-group" style="display:none">
          ...
          <!-- 세션 값을 비교 값으로 사용하는 이유 신규등록때문에 기존 게시물 정보가 없습니다. -->
          <c:forEach var="boardTypeVO" items="${listBoardTypeVO}">
            <option ${session_board_type==boardTypeVO.board_type?'selected':''} value="${boardTypeVO.board_type}">${boardTypeVO.board_name}선택</option>          
          </c:forEach>
      ...
      <div class="card-footer text-right">
        ...
        <a href="/admin/board/board_list?&bno=${pageVO.page}&search_type=${pageVO.search_type}" class="btn btn-info">목록</a>
      </div>
