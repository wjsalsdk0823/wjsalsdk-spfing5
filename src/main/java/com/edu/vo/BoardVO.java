...
/**
 * 이 클래스는 게시물 CRUD에 필요한 멤버변수(필드)가 정으된 클래스 입니다.
 * 목적은 데이터 변수 값 이동시get/set 작업이 주 목적입니다
 * @author 전민아
 *
 */
public class BoardVO {
	//멤버변수 생성
	private Integer bno;//PK식별값
	...
	private String board_type;//FK외래키
	//게시물 1개 등록시 첨부파일 1개이상 필요합니다
