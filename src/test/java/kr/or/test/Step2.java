...
class MemberVO {
	...
	//하나씩 출력하기 힘들때 자동으로 멤버 변수값을 출력하는 명령 toString생성(아래)
	@Override
	...
	public void setPhoneNum(String phoneNum) {
		this.phoneNum = phoneNum;//프라이빗 변수를 직접 접근을 못하니깐 
...
public class Step2 {
	...
	private static MemberVO[] members;

	public static void main(String[] args) {
		// MemberVO클래스자료형 객체를 생성합니다(아래)
		MemberVO memberVO = new MemberVO();
		memberVO.setName("홍길도");
		memberVO.setAge(10);
		...
		members[1] = memberVO2;
		members[2] = memberVO3;
		//출력도 메서드를 바로 호줄하지 않고,외부 클래스에서 객체로 만들어서 메서드를 호출합니다.
...
class MemberService {
	...
	public void printMember(MemberVO[] members) {
		// 멤버서비스 클래스에서 퍼블릿 접근제어로 회원정보를 출력하는 메서드 생성
		// 향상된 for문을 사용합니다
